...
def get_columns():
	...
	columns = [
		...
		{'label': 'Employer Amount', 'fieldname': 'tmrs_employer_total', 'fieldtype': 'Currency','width': 150},
		{'label': 'Total Contribution', 'fieldname': 'total_contribution', 'fieldtype': 'Currency','width': 150}
	]
	return columns
...
def generate_pdf(data):
	...
	html = frappe.render_template(template_path, {"data": data, "department_data": department_data, "department_grand_totals": department_grand_totals,"filter":filters, "current_datetime":formatted_datetime,"letterhead_image":letterhead_image, "company_name": company_name, "start_date":start_date,"end_date":end_date, "formatted_start_end_date":formatted_start_end_date,"month_year":month_year})
