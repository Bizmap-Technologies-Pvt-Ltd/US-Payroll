...
def generate_b_record(data):
	...
	_telephone_extension_box = ach_details.telephone_extension_box or ""
...
def generate_e_record(data):
	...
	_type_of_employment = ach_details.type_of_employment or ""

	_establishment_number_or_coverage_grouppru = ach_details.establishment_number_or_coverage_grouppru or ""

	_blocking_factor = ach_details.blocking_factor or ""
	...
	_tax_type_code = ach_details.tax_type_code or ""
	taxing_entity_code = ach_details.taxing_entity_code or ""
	_state_control_number = ach_details.state_control_number or ""
	_unit_number = ach_details.unit_number or ""
	_foreign_indicator = ach_details.foreign_indicator or ""
	_other_ein = ach_details.other_ein or ""
...
def generate_t_record(data):
	...
	_excess_wages = sum(emp.get("excess_wages", 0) for emp in data)
