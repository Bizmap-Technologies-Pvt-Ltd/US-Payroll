...
def generate_e_record(data):
	...
	state_unemployment_insurance_account_number = ach_details.state_unemployment_insurance_account_number or ""
...
def generate_t_record(data):
    ...
    return "T" + pad(total_employees, 7) + \
        pad(taxing_entity_code, 4) + \
        pad("", 14) + \
        pad(wages, 14) + \
        pad("", 14) + \
...
def generate_f_record(data):
	...
	return "F" + pad(total_employees, 10) + \
