...
frappe.ui.form.on("Form 941 Details", {
            ...
            frappe.call({
                ...
                callback: function(r) {
                    ...
                    if (total_taxes_after_adjustments) {
                        frm.set_value("total_taxes_after_adjustments", total_taxes_after_adjustments)
                        frm.set_value("total_taxes_after_adjustments_and_nonrefundable_credits", total_taxes_after_adjustments)
    ...
    total_social_security_and_medicare_taxes: function(frm) {
        if (frm.doc.total_social_security_and_medicare_taxes) {
            total_amount = frm.doc.total_social_security_and_medicare_taxes + frm.doc.federal_income_tax_withheld
