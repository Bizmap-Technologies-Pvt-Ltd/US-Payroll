frappe.ui.form.on('Employee', {
    ...
    toggle_display_accrual_pto_rate(frm) {
        ...
        frappe.db.get_value('Leave Type', 'PTO', 'custom_is_accrual_rate')
            .then(r => {
    ...
    custom_number_of_qualifying__children: function(frm) {
        frm.set_value('custom_children_credit', (frm.doc.custom_number_of_qualifying__children || 0) * 2000);
    ...
    calculate_total_dependents: function(frm) {
        frm.set_value('custom_total_credit',
    ...
    custom_filing_method: function(frm) {
        ...
        // get the latest submitted SSA for this employee
